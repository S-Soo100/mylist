...
class WheelchairCard extends StatelessWidget {
  const WheelchairCard({Key? key, required this.wheelchair}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            print("clicked!");
                            Provider.of<WheelchairListProvider>(context,
                                    listen: false)
                                .toggleFavorite(wheelchair);
                          },
                          icon: Icon(
                              wheelchair.favorite == true
                                  ? Icons.favorite
                                  : Icons.favorite_border,
                              color: wheelchair.favorite == true
                                  ? Colors.red
                                  : Colors.grey[600]),
                        )
                      ],
